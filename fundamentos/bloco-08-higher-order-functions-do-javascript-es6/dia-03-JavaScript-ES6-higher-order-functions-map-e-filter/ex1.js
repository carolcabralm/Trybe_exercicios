...
function formatedBookNames() {
  ...
  const booksFormated = books.map((obj) => `${obj.name} - ${obj.genre} - ${obj.author.name}`);
...
function fantasyOrScienceFiction() {
  // escreva seu código aqui
  const scienceFiction = books.filter((book) => book.genre === 'Ficção Científica' || book.genre === 'Fantasia');
